                    ...
                    <div class="table-responsive">
                        <table id="example1" class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT  votant.*,  etablissement.nom FROM  votant  LEFT JOIN  etablissement ON votant.id_etablissement = etablissement.id_etablissement WHERE  votant.intentionVote = 'favorable'";
