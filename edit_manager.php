	 ...
	 <header role="heading">
									<ul class="nav nav-tabs pull-left in">
										<li class="active" id="accountinfo1">
											<a data-toggle="tab" href="#" aria-expanded="true"> <i class="fa fa-lg fa-user"></i> <span class="hidden-mobile hidden-tablet"> Edit Account Manager </span> </a>
										</li>
											...
											<div class="smart-form">
													...
													<div class="row">
														<section class="col col-md-6">
															...
															<label class="input">
																...
																<input type="text" name="actUserId" value="" id="actUserId" placeholder="Enter User ID" maxlength="49" readonly="readonly">
															</label>
														...
														<section class="col col-md-6">
															...
															<label class="input">
																...
																<input type="password" name="actPass" value="*******" id="actPass" placeholder="********" maxlength="49">
															</label>
													...
													<div class="row">
														...
														<section class="col col-md-6">
															...
															<label class="input">
																...
																<input type="text" name="desiganation" value="Manager" id="desiganation" placeholder="Enter Designation" maxlength="49">
															</label>
												...
												<div class="row1">
													<div class="fieldset smart-form">
														<footer>
															<input class="btn btn-primary" placeholder="" type="button" id="update" value="Update" onclick="CreateAcountManager();">
