...
<div class="col-md-12">
	...
	<form action="add_user_back.php" method="post" id="contact-form" novalidate="novalidate" onsubmit="verify();" enctype="multipart/form-data">
															...
															<div class="row">
																<section class="col col-md-6">
																	...
																	<label class="input">
																		...
																		<input type="text" name="nom_candidat" value="" id="nom_candidat" placeholder="Nom du candidat" maxlength="49">
																...
																<section class="col col-md-6">
																	...
																	<label class="input">
																		<i class="icon-append fa fa-user"></i>
																		<input type="text" name="prenom_candidat" value="" id="prenom_candidat" placeholder="Prenom du candidat" maxlength="49">
																	</label>
																	<div style="color: #FF0000;"></div>
																</section>
															</div>
