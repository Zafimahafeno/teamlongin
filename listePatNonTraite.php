...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Liste des PAT non traité</h1>
        <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
        <div class="row">
            ...
            $sql = " SELECT v.*, e.nom AS nom_etablissement FROM votant v LEFT JOIN etablissement e ON v.id_etablissement = e.id_etablissement WHERE (v.intentionVote = 'Non traité' OR v.intentionVote = '')AND (v.fonction = 'PAT')ORDER BY v.nom_votant";
