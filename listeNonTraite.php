...
.dataTables_filter {
    margin-bottom: 15px;
    /* Ajoute de l'espace sous la barre de recherche */
}

.dataTables_wrapper .dataTables_filter input {
    margin-left: 10px;
    /* Espacement du champ de recherche */
    padding: 5px;
    border-radius: 5px;
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>Liste des votants non traité</h1>
        <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
        <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="pull-right">
                                ...
                                <button class="btn btn-primary"
                                    onclick="window.location.href='telecharger_candidat1.php'"
            ...
            $sql = " SELECT v.*, e.nom AS nom_etablissement FROM votant v LEFT JOIN etablissement e ON v.id_etablissement = e.id_etablissement WHERE (v.intentionVote = 'Non traité' OR v.intentionVote = '')AND (v.fonction = 'PAT' OR(v.fonction = 'Enseignant' AND v.tel <> ''))ORDER BY v.nom_votant";
    ...
    <!-- Modal -->
    <div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="modalTitle"
        aria-hidden="true">
