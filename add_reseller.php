...
?>
																	...
																	<div class="row">
																		...
																		<section class="col col-md-3">
																			...
																			<label class="input">
																				...
																				<input type="password" name="password" value="" placeholder="Password" id="txtpassword" maxlength="90">
																				<div style="color: #FF0000;"></div>
																			</label>
																		</section>
																		<section class="col col-md-3">
																		...
																		<section class="col col-md-3">
																			...
																			<label class="input">
																				<input name="balance" value="" id="balance" type="text" placeholder="Account Balance" maxlength="18">
																			</label>
																	...
																	<div class="row">
																		<section class="col col-md-6">
																			...
																			<label class="input">
																				...
																				<input type="text" name="email" value="" id="email" placeholder="User Email ID" maxlength="50">
																			</label>
																			<div style="color: #FF0000;"></div>
																		</section>
																		<section class="col col-md-6">
																			...
																			<label class="input">
																				...
																				<input type="text" name="web" value="" id="web" placeholder="Domain/Host" maxlength="49">
																			</label>
																			<div style="color: #FF0000;"></div>
																		</section>
																	</div>
  ...
  <footer class="main-footer dark-bg">
    ...
    Copyright &copy; 2019 SMPP Admin. All rights reserved. 
</footer>
</div>
<!-- wrapper --> 
