				...
				<header role="heading">
					<ul class="nav nav-tabs pull-left in">
						...
						<li class="active" id="accountinfo1">
							...
							<a data-toggle="tab" href="#accountinfo" aria-expanded="true"> <i
									class="fa fa-lg fa-user"></i> <span class="hidden-mobile hidden-tablet"> User
									Account </span> </a>
						...
						<li id="personalinfo1" class="">
							<a data-toggle="tab" href="#personalinfo"> <i class="fa fa-lg fa-info-circle"></i> <span
									class="hidden-mobile hidden-tablet"> Personal Info </span> </a>
						</li>

						<li id="otherinfo1" class="">
							<a data-toggle="tab" href="#otherinfo" aria-expanded="false"> <i
									class="fa fa-lg fa-indent"></i> <span class="hidden-mobile hidden-tablet"> Other
								</span> </a>
						</li>
						<li id="discountinfo1" class="">
							<a data-toggle="tab" href="#discountinfo" aria-expanded="false"> <i
									class="fa fa-lg fa-indent"></i> <span class="hidden-mobile hidden-tablet"> Discount
									Info </span> </a>
						</li>
					</ul>
				</header>
				...
				<div class="chart-box">
					...
					<form action="" method="post" id="contact-form" novalidate="novalidate" onsubmit="verify();">
						<div class="tab-content">
														...
														<section class="col col-md-3">
															...
															<label class="input">
																...
																<input type="text" name="smppUserId" value=""
																	id="smppUserId" placeholder="User ID"
																	maxlength="25">
																<input type="hidden" value="UserIdField" name="field"
																	id="UserField">
														...
														<section class="col col-md-3">
															...
															<label class="input">
																<i class="icon-append fa fa-lock" data-container="body"
																	...
																	data-original-title="   Password Generator    "
																	data-content="Auto generate password, click here."
																	onclick="getPasswordGenerator();"></i>
														...
														<section class="col col-md-3">
															...
															<label class="input">
																...
																<input type="text" name="systemType" value=""
																	id="systemType" placeholder="System Type"
																	maxlength="3">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
													...
													<div class="row">
														...
														<section class="col col-md-3">
															...
															<label class="input">
																...
																<input type="text" name="limitSmsPerDay" value="N/A"
																	id="limitSmsPerDay" placeholder="N/A"
																	maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
														<section class="col col-md-3">
															...
															<label class="input">
																<i class="icon-append fa fa-history"></i>
																<input type="text" name="LimitSmsPerHour" value="N/A"
																	id="LimitSmsPerHour" placeholder="N/A"
																	maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
													...
													<div class="row">
															...
															<div class="input-group">
																<label class="input">
																	<input name="validity" value="" id="validity"
																		type="text" placeholder="Account Validity"
																		maxlength="4">
																</label>
														...
														<section class="col col-md-3">
															...
															<label class="select">
																...
																<select name="balanceMode" onchange="getBalanceMode();"
																	id="balanceMode">
																	<option value="PREPAID" selected="selected">PREPAID
																	</option>
														...
														<section class="col col-md-3">
															...
															<div class="input-group">
																...
																<label class="input">
																	<input name="balance" value="" id="balance"
															...
															<div class="row">
																...
																<div class="col col-7 col-md-7">
																	<div class="input" id="tpsPerSession">
																		...
																		<input placeholder="TPS Per Session" type="text"
																			name="tpsPerSession" maxlength="5">
																	</div>
																</div>
															</div>
															<div class="row">
																<label class="label col col-md-4">
																	<input type="radio" class="radiobox style-0"
																		name="tps" checked="checked" id="tps">
																	<span>Total TPS</span>
																</label>
																<div class="col col-7 col-md-7">
																	<div class="input" id="totalTps">
																		<i class="icon-append fa fa-exchange"></i>
																		<input placeholder="Total TPS" type="text"
																			name="totalTps" value="10" maxlength="5">
																		<input type="hidden" name="tpsName" value="tps"
																			id="tpsName">
																	</div>
																</div>
															</div>
															...
															<div class="row1">
																...
																<div class="col-md-12">
																	...
																	<label class="label col col-md-2">
																		<input type="checkbox" class="checkbox style-0"
																			name="active" id="active" checked="checked">
																		<span>Active</span>
																	</label>
																	...
																	<label class="label col col-md-4">
																		<input type="checkbox" class="checkbox style-0"
																			name="txtRollback" id="txtRollback">
														...
														<div class="col-sm-12 col-md-12 col-md-9">
															<div class="form-group">
																...
																<div class="row1">
																	<label class="label col col-md-2">
																		<input type="checkbox" class="checkbox style-0"
																			name="txtCheckTime" id="txtCheckTime">
																		<span>Check Time</span>
																	</label>
																	<div class="col col-md-10" id="txtTimeInterval"
																		style="display: none;">
														...
														<div class="col-md-12 text-right">
															<div class="col-lg-12">
																<a data-toggle="tab" href="#personalinfo"
																	...
																	onclick="getTab('personalinfo1');"
																	aria-expanded="true">&nbsp;&nbsp;Next&nbsp;&nbsp;</a>
														...
														<section class="col col-md-6">
															...
															<label class="input">
																...
																<input type="text" name="email" value="" id="email"
																	placeholder="User Email ID" maxlength="49">
															</label>
															<div style="color: #FF0000;"></div>
														</section>
														<section class="col col-md-6">
															...
															<label class="input">
																...
																<input type="text" name="web" value="" id="web"
																	placeholder="Web" maxlength="49">
															</label>
															<div style="color: #FF0000;"></div>
														</section>
													</div>
															...
															<div class="col-sm-12">
																<div class="input-group1">
																	...
																	<div class="col-md-8">
																		<label class="input">
																			<i class="icon-append fa fa-phone"></i>
																			<input type="text" name="otherNo" value=""
																				id="otherNo" placeholder="Phone No"
																				maxlength="9">
																		</label>
																		<div style="color: #FF0000;"></div>
																	</div>
										...
										<div class="tab-pane active" id="AA12">
													...
													<div class="col-sm-12 col-md-12 col-lg-6 smart-form">
														<div class="row1">
															<label class="label col col-md-5">
																<input type="checkbox" class="checkbox style-0"
																	name="globalContFilter" id="globalContFilter"
																	checked="checked">
																<span>Global Content Filter</span>
																<input type="hidden" name="globalhiddenContFilter"
																	value="global" id="globalhiddenContFilter">
															</label>
													...
													<div class="col-sm-12 col-md-12 col-lg-6">
														<div class="row">
															...
															<section class="col-md-7" id="BlockedContentCate">
																<select name="BlockedContentCate" multiple=""
												...
												<div class="row">
													<div class="col-sm-12 col-md-6 col-lg-6">
														<div class="row">
															...
															<section class="col-md-7">
																<select name="blacklistNumberCategory" multiple=""
																	class="select2 select2-hidden-accessible"
																	style="width: 100%" tabindex="-1"
																	aria-hidden="true">
													...
													<div class="col-sm-12 col-md-6 col-lg-6">
														<div class="row">
															...
															<section class="col-md-7">
																<select name="whitelistNumberCategory" multiple=""
																	class="select2 select2-hidden-accessible"
																	style="width: 100%" tabindex="-1"
																	aria-hidden="true">
														...
														<div class="col-sm-12 col-md-12 col-lg-6">
															<div class="well1">
																...
																<div class="row1">
																	...
																	<label class="label col col-md-5">
																		<input type="radio" class="radiobox style-0"
																			name="Sender" id="fxdSender"
																			checked="checked">
																		<span>Fixed Sender</span>
																		<input type="hidden" name="dynamicAddress"
																			id="dynamicSourceAddress"
																			value="senderIdOverWrite" maxlength="6">
																	</label>

																	<div class="col col-7 col-md-7" id="fixedSender">
																		<div class="input">
																			<i
																				class="icon-append fa fa-info-circle"></i>
																			<input placeholder="Fixed Sender"
																				type="text" name="senderIdToOverWrite"
																				value="" maxlength="6">
																		</div>
																	</div>
																	...
																	<label class="label col col-12 col-md-12">
																		<input type="radio" class="radiobox style-0"
																			name="Sender" id="dynamicSender">
																		<span>Dynamic</span>
																	</label>
																	<label class="label col col-12 col-md-12">
																		<input type="radio" class="radiobox style-0"
																			name="Sender" id="approvedSender" value="">
																		<span>Approved</span>
																	</label>
																	...
																	<div>
																		...
																		<div class="row" style="margin: 0 0;">
																			<label class="label col col-md-5">
																				<input type="checkbox"
																					...
																					name="senderIdAlphaAllow"
																					id="senderIdAlphaAllow"
																					disabled="disabled">
																				<span>Allow Alpha Sender</span>
																			</label>
																			<section class="col-md-7 col"
																				id="senderIdAlphaAlength">
																				<label class="select">
																		...
																		<div class="row" style="margin: 0 0;">
																			<label class="label col col-md-5">
																				<input type="checkbox"
																					class="checkbox style-0"
																					name="senderIdAlNumAllow"
																					id="senderIdAlNumAllow"
																					disabled="disabled">
																				<span>Allow Numeric Sender</span>
																			</label>
																			<section class="col-md-7 col"
																				id="senderIdANumLength">
																				<label class="select">
																		...
																		<div class="row" style="margin: 0 0;">
																			<label class=" label col col-md-5">
																				<input type="checkbox"
																					class="checkbox style-0"
																					name="senderIdAlphaNumAllow"
																					id="senderIdAlphaNumAllow"
																					disabled="disabled">
																				<span>Allow AlphaNum Sender</span>
																			</label>
																			<section class="col-md-7 col"
																				id="senderIdAlphaNumLength">
																				<label class="select">
																					<select
																						name="senderIdAlphaNumLength">
																		...
																		<div class="row" style="margin: 0 0;">
																			<label class=" label col col-md-5">
																				<input type="checkbox"
																					class="checkbox style-0"
																					name="checkDefaultsenderId"
																					id="checkDefaultsenderId"
																					disabled="disabled">
																				<span>Default Sender</span>
																			</label>
																			<section class="col-md-7 col"
																				id="defaultSenderIdTab">
																				<div class="input">
																					<i
																						class="icon-append fa fa-info-circle"></i>
																					<input placeholder="Fixed Sender"
																						type="text"
																						name="defaultSenderId" value=""
																						maxlength="6">
																				</div>
																				<div style="color: #FF0000;"></div>
																			</section>
											...
											<div class="smart-form">
														...
														<section class="col col-md-4">
															...
															<label class="input">
																...
																<input type="text" name="dndErrorCode" value="900"
																	id="dndErrorCode" placeholder="DND ErrorCode"
																	maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
														<section class="col col-md-4">
															<label class="label">Day Balance Error Code<font
																	color="red">*</font></label>
															<label class="input">
																<i class="icon-append fa fa-dollar"></i>
																<input type="text" name="dayBalErrorCode" value="88"
																	id="dayBalErrorCode"
																	placeholder="Day Balance Error Code" maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
														<section class="col col-md-4">
															<label class="label">Hour Balance Error Code<font
																	color="red">*</font></label>
															<label class="input">
																<i class="icon-append fa fa-dollar"></i>
																<input type="text" name="hourBalErrorCode" value="88"
																	id="hourBalErrorCode"
																	placeholder="Hour Balance Error Code"
																	maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
												...
												<div class="fieldset">
													<div class="row">
														<section class="col col-md-4">
															<label class="label">No Balance Error Code<font color="red">
																	*</font></label>
															<label class="input">
																<i class="icon-append fa fa-dollar"></i>
																<input type="text" name="nobalErrorCode" value="1035"
																	id="nobalErrorCode"
																	placeholder="No Balance Error Code" maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
														<section class="col col-md-4">
															<label class="label">Blocked Content Error Code<font
																	color="red">*</font></label>
															<label class="input">
																<i class="icon-append fa fa-filter"></i>
																<input type="text" name="blockContentErrorCode"
																	value="102" id="blockContentErrorCode"
																	placeholder="Blocked Content Error Code"
																	maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
														<section class="col col-md-4">
															<label class="label">Blocked Sender ID Error Code<font
																	color="red">*</font></label>
															<label class="input">
																<i class="icon-append fa fa-info-circle"></i>
																<input type="text" name="blocSenderIderrorCode"
																	value="10" id="blocSenderIderrorCode"
																	placeholder="Blocked Sender Id Error Code"
																	maxlength="10">
																<div style="color: #FF0000;"></div>
															</label>
														</section>
												...
												<footer>
													...
													<button type="button" class="btn btn-primary" id="processAdd"
														style="display: none;">
							...
							<div class="tab-pane" id="discountinfo">
								<div class="tabbable tabs-below">
									<div class="tab-content padding-10">
										<div class="tab-pane active" id="DAA">
											<form action="" method="post" id="contact-form" class="smart-form1"
												...
												<div class="fieldset">
													...
													<div class="row">
														...
														<div class="col-sm-12 col-md-12 col-lg-4 smart-form">
															<label class="label col col-md-5">
																<input type="checkbox" class="checkbox style-0"
																	name="enbdiscount" id="enbdiscount">
																<span>Is Discount</span>
															</label>
															<div class="col-md-7 col" id="discountvaluetab"
																style="display: none;">
																<label class="input">
																	<input name="disvalue" id="disvalue" value="0">
														...
														<div class="col-sm-12 col-md-12 col-lg-4">
															<div class="col-md-12" id="whitelistdiscattab"
																style="display: none;">
																<select name="whitelistDisNumberSmsCategory" multiple=""
																	class="select2 select2-hidden-accessible"
																	style="width: 100%" tabindex="-1"
																	aria-hidden="true">
																	...
																	dir="ltr" style="width: 100%;"><span
																		...
																		aria-hidden="true"></span></span>
																<span>Discount WhiteList Categoary </span>
																<div style="color: #FF0000;"></div>
															</div>
														</div>
														<div class="col-sm-12 col-md-12 col-lg-4">
															<div class="col-md-12" id="whitelistdisconttab"
																style="display: none;">
																<select name="discountcontentcategoary" multiple=""
																	class="select2 select2-hidden-accessible"
																	style="width: 100%" tabindex="-1"
																	aria-hidden="true">
																	...
																	dir="ltr" style="width: 100%;"><span
																		...
																		aria-hidden="true"></span></span>
																<span>Discount Content Categoary </span>
																<div style="color: #FF0000;"></div>
															</div>
														</div>
												...
												<input type="hidden" name="txtaction" value="Discount">
												<input type="hidden" name="systemId" value="INUSER311">
												<input type="hidden" name="editUserId" value="abbsnl-num">
											</form>
										</div>
									</div>
								</div>
