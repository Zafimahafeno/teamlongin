    ...
    <section class="content container-fluid">
	  ...
	  <header role="heading">
                                 ...
                                 <li id="discountinfo1" class="">
											<a data-toggle="tab" href="#discountinfo" aria-expanded="false"> <i class="fa fa-lg fa-indent"></i> <span class="hidden-mobile hidden-tablet"> Discount Info </span> </a>
										</li>
									</ul>
								</header>
								</div>
																				...
																				<div class="col col-4">
																					...
																					<div class="input-group">
																						<span class="input-group-addon">
																							<span class="radio">
																								<label>
																									<input type="radio" class="radiobox style-0" name="bindType" id="bindType" checked="checked">
																									<span> Bind Type</span> 
																								</label>
																							</span>
																						</span>
																						...
																						<span class="input-group-addon">
																							<span class="radio">
																								<label>
																									<input type="radio" class="radiobox style-0" name="bindType" id="other1">
																									<span> Other</span> 
																								</label>
																							</span>
																						</span>
												...
												<div class="tabbable tabs-below">
													<div class="tab-content padding-10">
														<div class="tab-pane active" id="AA12">
															<fieldset>
																<div class="row">
																	<div class="smart-form"><header>Content Management</header></div>	
											...
											<div class="tabbable tabs-below">
												<div class="tab-content padding-10">
													<div class="tab-pane active" id="DAA">
														<form action="" method="post" id="contact-form" class="smart-form1" novalidate="novalidate">
															<div class="fieldset">
...
<style type="text/css">
	#discountvaluetab,#whitelistdiscattab,#whitelistdisconttab{
    	display:none;
	}
</style>
																	<div class="col-sm-12 col-md-12 col-lg-4 smart-form">
																		<label class="label col col-md-5">
																			<input type="checkbox" class="checkbox style-0" name="enbdiscount" id="enbdiscount">
																			<span>Is Discount</span> 
																		</label>
																		<div class="col-md-7 col" id="discountvaluetab" style="display: none;">
																			<label class="input">
																	...
																	<div class="col-sm-12 col-md-12 col-lg-4">
																		<div class="col-md-12" id="whitelistdiscattab" style="display: none;">
																			<select name="whitelistDisNumberSmsCategory" multiple="" class="select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true">
																	...
																	<div class="col-sm-12 col-md-12 col-lg-4">
																		<div class="col-md-12" id="whitelistdisconttab" style="display: none;">
																			<select name="discountcontentcategoary" multiple="" class="select2 select2-hidden-accessible" style="width: 100%" tabindex="-1" aria-hidden="true">
															...
															<div class="smart-form">
															<footer>
																<button type="submit" name="submit" class="btn btn-danger" onclick="window.history.back()">Cancel</button>
